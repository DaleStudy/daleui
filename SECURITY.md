...
1. **신고 방법:**
   ...
   - GitHub 이슈: [https://github.com/dale-study/daleui/issues](https://github.com/dale-study/daleui/issues)
...
1. **접수 확인:**
   ...
   - 취약점 신고를 받은 후 가능한 빠른 시간 내에 GitHub을 통해 접수 확인 답변을 드리겠습니다.
...
3. **결과 공유:**
   - 취약점 패치가 완료되면, 해당 사항을 GitHub 릴리스 노트에 공개합니다.
   - 완료 후 신고자님께 이슈를 통해 처리 결과를 알려드립니다.

## 추가 정보

보안 문제에 대한 자세한 문의나 건의 사항은 [GitHub 이슈](https://github.com/dale-study/daleui/issues)를 통해 연락해 주시기 바랍니다.
