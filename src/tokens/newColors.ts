...
export const semanticColors: SemanticTokens["colors"] = {
  ...
  foreground: {
    default: {
      primary: {
        value: { base: "{colors.slate.12}", _dark: "{colors.darkSage.12}" },
      },
      secondary: {
        value: { base: "{colors.slate.11}", _dark: "{colors.darkSage.11}" },
      },
      tertiary: {
    ...
    Inverse: {
      primary: {
        value: { base: "{colors.violet.1}", _dark: "{colors.darkSage.2}" },
      },
    },
    accent: {
      primary: {
        value: { base: "{colors.violet.8}", _dark: "{colors.darkTeal.10}" },
      },
      teal: {
        value: { base: "{colors.teal.7}", _dark: "{colors.darkViolet.7}" },
      },
    },
    system: {
      success: {
  ...
  borders: {
    interactive: {
      primary: {
        ...
        focus: {
          value: { base: "{colors.violet.10}", _dark: "{colors.darkTeal.11}" },
        },
        press: {
          value: { base: "{colors.violet.12}", _dark: "{colors.darkTeal.11}" },
        },
      },
      secondary: {
        default: {
          value: { base: "{colors.slate.8}", _dark: "{colors.darkSage.6}" },
        },
        hover: {
          value: { base: "{colors.slate.9}", _dark: "{colors.darkSlate.7}" },
        },
        press: {
          value: { base: "{colors.slate.10}", _dark: "{colors.darkSlate.8}" },
        },
      },
      focus: {
  ...
  background: {
    default: {
      primary: {
        value: { base: "{colors.slate.1}", _dark: "{colors.darkSage.2}" },
      },
      secondary: {
        value: { base: "{colors.slate.3}", _dark: "{colors.darkSlate.3}" },
      },
      tertiary: {
        value: { base: "{colors.slate.5}", _dark: "{colors.darkSlate.3}" },
      },
      disabled: {
        value: { base: "{colors.slate.6}", _dark: "{colors.darkSlate.7}" },
      },
    },
    interactive: {
      primary: {
        default: {
          value: { base: "{colors.violet.9}", _dark: "{colors.darkTeal.11}" },
        },
        hover: {
          value: { base: "{colors.violet.10}", _dark: "{colors.darkTeal.12}" },
        },
        press: {
          value: { base: "{colors.violet.12}", _dark: "{colors.darkTeal.12}" },
        },
      ...
      secondary: {
        ...
        press: {
          value: { base: "{colors.slate.4}", _dark: "{colors.darkSage.5}" },
        },
      },
      danger: {
    ...
    accent: {
      primary: {
        value: { base: "{colors.violet.9}", _dark: "{colors.darkTeal.10}" },
      },
      secondary: {
