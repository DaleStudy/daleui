...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: `
카드는 정보 전달 또는 특정 페이지나 리소스로 사용자를 이동시키는 것을 주목적으로 하는 컴포넌트입니다.
- 링크가 없는 경우 정보 전달을 목적으로 사용합니다.
- 링크가 있는 경우에는 카드 전체 영역 또는 특정 CTA 버튼이 하이퍼링크로 동작합니다. 이때 사용자에게 “여기를 클릭하면 새로운 곳으로 이동한다”는 점을 직관적으로 인지시키는 탐색형 카드입니다.
